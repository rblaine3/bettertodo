    ...
    <nav className="fixed bottom-0 left-0 right-0 bg-zinc-900/80 backdrop-blur-lg border-t border-zinc-800">
      <div className="max-w-screen-xl mx-auto px-4">
        <div className="flex items-center justify-around h-16">
          ...
          <Link 
            href="/tasks/create" 
            className={`button rounded-full w-12 h-12 flex items-center justify-center p-0 -mt-6 shadow-lg
                       hover:bg-blue-600 transition-colors ${pathname === '/tasks/create' ? 'bg-blue-600' : ''}`}
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
